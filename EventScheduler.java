...
final class EventScheduler
{
   ...
   private Map<EntityI, List<Event>> pendingEvents;
   ...
   public void scheduleEvent(EntityI entity, ActionI action, long afterPeriod)
   {
   ...
   public void unscheduleAllEvents(EntityI entity)
   {
