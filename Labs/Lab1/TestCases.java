...
public class TestCases
{
   ...
   {
      assertEquals(45.1, SimpleIf.max(45.1, 5.4), DELTA);
   }
   ...
   {
      assertFalse(BetterLoop.contains(new int[] {1, 2, 3, 4, 5, 6, 7}, 8));
   }
   ...
   {
      List<String> expected = Arrays.asList("Julie", "Zoe", "Yash", "Alex");
      Map<String, List<Course>> courseListsByStudent = new HashMap<>();
      ...
      courseListsByStudent.put("JR",
         Arrays.asList(
            ...
            new Course("CPE 476", 4),
            new Course("CPE 572", 4),
	    new Course("CPE 1000000", 4)));
      courseListsByStudent.put("Yash",
         Arrays.asList(
            new Course("CPE 123", 4),
            new Course("CPE 203", 4),
            new Course("CPE 471", 4),
