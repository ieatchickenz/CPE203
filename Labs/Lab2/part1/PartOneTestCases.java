...
public class PartOneTestCases
{
   ...
   public void testPerimCircle(){
	...
	double perim = Util.perimeter(new Circle(center, radius));
   ...
   public void testPerimRect(){
	...
	Point bottomRight = new Point(3.0, 1.0);
	double perim = Util.perimeter(new Rectangle(topLeft, bottomRight));
   ...
   public void testPerimPoly(){
	...
	double perim = Util.perimeter(new Polygon(points));
