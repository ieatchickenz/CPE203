...
public final class VirtualWorld
   ...
   private static final int VIEW_WIDTH = 1280; //640;
   private static final int VIEW_HEIGHT = 960;//480;
   ...
   */
   ...
   private static void scheduleActions(WorldModel world,
      ...
      for (EntityI entity : world.getEntities()) {
         if (entity instanceof EntityAction) {
            ((EntityAction) entity).scheduleAction(scheduler, world, imageStore);
         }
      }
   }
